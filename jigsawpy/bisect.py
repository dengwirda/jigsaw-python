...
#------------------------------ obj. to store index mappings
    def __init__(self):
        INDX = jigsaw_msh_t.INDEX_t
        self.edge2 = struct()
        self.edge2.index = \
            np.empty((0, 0), dtype=INDX)
...
#------------------------------ create new indexes for TRIA4
        ...
        costA = triscr3(verts["coord"],
                        triaA["index"])
        costB = triscr3(verts["coord"],
                        triaB["index"])
        costC = triscr3(verts["coord"],
                        triaC["index"])
        costD = triscr3(verts["coord"],
                        triaD["index"])
        ...
        costE = triscr3(verts["coord"],
                        triaE["index"])
        costF = triscr3(verts["coord"],
                        triaF["index"])
        costG = triscr3(verts["coord"],
                        triaG["index"])
        costH = triscr3(verts["coord"],
                        triaH["index"])
        ...
        costI = triscr3(verts["coord"],
                        triaI["index"])
        costJ = triscr3(verts["coord"],
                        triaJ["index"])
        costK = triscr3(verts["coord"],
                        triaK["index"])
        costL = triscr3(verts["coord"],
                        triaL["index"])
