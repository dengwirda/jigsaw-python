...
def save_grid_file(mesh,fptr):
    ...
    fptr.write("DIMENSIONS " + str(dims[0])
                       + " " + str(dims[1])
                       + " " + str(dims[2]) 
                       + " \n" )
    ...
    #----------------------------------- write VALUE attrib.
        ...
        perm = [1, 0] + \
            list(range(2,mesh.value.ndim))
        data = \
            np.transpose(mesh.value,perm)
    ...
    #----------------------------------- write SLOPE attrib.
        ...
        perm = [1, 0] + \
            list(range(2,mesh.slope.ndim))
        data = \
            np.transpose(mesh.slope,perm)
